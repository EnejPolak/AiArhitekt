...
export interface StepInteriorStyleProps {
  data: "modern" | "scandinavian" | "minimalist" | "industrial" | "luxury" | "rustic" | "japandi" | "mediterranean" | null;
  onComplete: (data: "modern" | "scandinavian" | "minimalist" | "industrial" | "luxury" | "rustic" | "japandi" | "mediterranean") => void;
}
...
export const StepInteriorStyle: React.FC<StepInteriorStyleProps> = ({ data, onComplete }) => {
  const [selectedStyle, setSelectedStyle] = React.useState<typeof STYLE_OPTIONS[number]["id"] | null>(data || null);
