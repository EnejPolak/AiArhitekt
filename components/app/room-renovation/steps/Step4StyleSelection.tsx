...
export interface Step4StyleSelectionProps {
  selectedStyles: string[];
  onStylesChange: (styles: string[]) => void;
  onContinue: () => void;
}

// SVG Icons for each style (minimal, architectural, blueprint-style)
const ModernIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    {/* Modern furniture - clean rectangles */}
...
const LuxuryIcon = ({ className }: { className?: string }) => (
  ...
  >
    {/* Room outline */}
    <rect x="10" y="10" width="100" height="60" />
    {/* Elegant curves and ornate details */}
...
const RusticIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 120 80"
    fill="none"
    stroke="currentColor"
  ...
  >
    ...
    <path d="M 20 30 L 30 25 L 40 30 L 40 45 L 20 45 Z" />
    <path d="M 55 35 Q 60 30, 65 35 Q 70 40, 65 45 Q 60 50, 55 45 Q 50 40, 55 35" />
    <path d="M 75 25 L 85 20 L 95 25 L 95 50 L 75 50 Z" />
  </svg>
);
...
const styleOptions = [
  ...
  },
  {
    id: "rustic",
    label: "Rustic",
    descriptor: "Natural textures · Warm earth tones",
    icon: RusticIcon,
  },
];

export const Step4StyleSelection: React.FC<Step4StyleSelectionProps> = ({
  selectedStyles,
  onStylesChange,
  onContinue,
}) => {
