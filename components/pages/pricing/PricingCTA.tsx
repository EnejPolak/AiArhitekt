...
export const PricingCTA: React.FC<PricingCTAProps> = ({ className }) => {
  return (
    <section
      className={cn(
        "w-full py-28 md:py-36 relative overflow-hidden",
        className
      )}
    >
      ...
      <Container className="px-6 md:px-10 lg:px-20 relative z-10">
        ...
        >
          ...
          >
            <Button
              variant="default"
              className="px-8 py-4 text-base font-semibold rounded-[14px] shadow-[0_4px_20px_rgba(0,255,210,0.15)]"
            >
              Start Your Project
            </Button>
          </motion.div>
