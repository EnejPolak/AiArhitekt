...
export const SignInForm: React.FC<SignInFormProps> = ({ className }) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-[28px] md:text-[30px] font-semibold md:font-bold leading-[1.2] tracking-[-0.01em] text-white mb-4">
          Sign in to Arhitekt AI
        </h1>
        <p className="text-sm md:text-base text-[rgba(255,255,255,0.70)]">
        ...
        <div className="flex items-center justify-between pt-2">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-[rgba(255,255,255,0.18)] bg-[rgba(255,255,255,0.04)] text-[rgba(0,230,204,0.7)] focus:ring-[rgba(0,230,204,0.3)] focus:ring-offset-0"
            />
            <span className="text-sm md:text-[15px] text-[rgba(255,255,255,0.70)]">
              Remember me
            </span>
          </label>
          <Link
            href="/forgot-password"
            className="text-sm text-[rgba(0,230,204,0.8)] hover:text-[rgba(0,230,204,1)] hover:underline transition-colors"
          >
            Forgot password?
          </Link>
        </div>
